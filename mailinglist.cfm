<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
		<html>
			...
			<title>Streamline - Mailing List</title>
		...
		<form method="post" id="addToMailListForm" action="go/mailinglist-action-join">
			<div>
				...
				<p class="captcha" align="center">
									...
									<img src="/go/captcha-display?captcha_hr=AED29880-BFC7-9EAE-575144FD669C7AF5" vSpace="10" border="1" style="display:block;"/><input name="captchaHash" type="hidden" value="AED29880-BFC7-9EAE-575144FD669C7AF5" />
								</p>
