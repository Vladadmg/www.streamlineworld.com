...
<br/>
		...
		<a name="custom-form-73"></a>
		<form action="/streamteam.cfm?form_action=submit" method="POST">
			<input type="hidden" name="_formName" value="65310_89007"><input type="hidden" name="_return" value="/streamteam.cfm?#custom-form-73"><span style="display:none;"><input id="profession" name="profession" size="30" type="text" value="" /></span> 
			
			<div class="custom-form">
				
				<p class="custom-form-header" id="custom-form-73">form</p>
					...
					<p>
						<label for="field_223">
							<strong>ZIP code (or City/State)</strong>:
						</label><br />
					...
					<p class="captcha">
						...
						<input tabindex="78" type="text" name="captchaText" size="20" />
						
						<img src="/go/captcha-display?captcha_hr=AECDB739-0E5E-C22E-511C0FE1B415BD62" vSpace="10" border="1" style="display:block;"/><input name="captchaHash" type="hidden" value="AECDB739-0E5E-C22E-511C0FE1B415BD62" />
					</p>
				
				<p><input tabindex="79" class="button" type="submit" name="login" id="login" value="Submit Form"/></p>
			</div>
		</form>
